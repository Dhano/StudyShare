...
import ui.core.services.Authenticator;
import ui.core.services.microservices.Comms;
import ui.core.services.microservices.database.Group;
...
import ui.core.services.microservices.filehandling.FileWatcher;
import ui.core.services.microservices.filehandling.callback.FileWatcherCallback;
import ui.core.services.microservices.threadpool.SequenceConvulsion;
	...
	* */
	...
	public void shutdownNow() {
		try {
			...
			Logger.wtf(ioe.getStackTrace().toString());
		}
	}
